...
(defun manual-entry-at-position ()
  "リージョン指定時はそのリージョンを単語として取得。そうでない時は、
カーソル位置の単語をthing-at-pointで取得する。そして、それをmanual-entry
に渡すだけ。"
  (interactive)
...
;; 上はファイル数に比例した関数呼出のネストが起こるがネストが
;; 深くて実行できない場合があるので while にした。
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; 個人的にホームページは /home/tak/homepage/ で編集してアップロードしている
;; 自分のページを見るのに、まず自分のページにどんなファイルがあるかを知る目安と
;; して、 /home/tak/homepage/ にあるファイルをつかう。 /home/tak/homepage/ に
;; あるファイルの中で .html 拡張子がついたものをとりあげて、これをタブ補間入力
;; できるようにする。
